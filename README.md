...
```ruby
github "IPay88Cambodia/IPay88-iOS-Sdk" "2.0.0-SNAPSHOT"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/ipay88cambodia/ipay88-ios-sdk.git", .exact(Version("2.0.0-SNAPSHOT")))
]
```
...
- Step 3. In the search result  > Select `ipay88-ios-sdk`
  + Dependency Rule: `Exact Version` > Enter the version number `2.0.0-SNAPSHOT`
